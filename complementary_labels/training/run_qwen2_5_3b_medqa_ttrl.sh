#!/usr/bin/env bash
# TTRL-style GRPO training for Qwen2.5-3B on the full MedQA full-option train split.
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen2_5_3b_ttrl_full}
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${HOME}/checkpoints/complementary_labels_ttrl_full"}
