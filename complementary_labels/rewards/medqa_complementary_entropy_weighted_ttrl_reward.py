#!/usr/bin/env python3
"""Entropy-weighted TTRL reward with complementary-label penalty for MedQA."""
...
class MedQAComplementaryEntropyWeightedTTRLRewardManager(RewardManagerBase):
    """Batch reward manager for entropy-weighted TTRL plus complementary penalty."""
...
def compute_score(**kwargs):
    del kwargs
    raise RuntimeError(
        "Use MedQAComplementaryEntropyWeightedTTRLRewardManager.run_batch for complementary entropy-weighted TTRL."
    )
