#!/usr/bin/env bash
# GRPO training for Qwen2.5-3B on the full MedQA full-option train split.
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen2_5_3b_grpo_full}
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${HOME}/checkpoints/complementary_labels_full"}
...
REWARD=(
    ...
    reward.custom_reward_function.path="${PROJECT_DIR}/rewards/medqa_reward.py"
