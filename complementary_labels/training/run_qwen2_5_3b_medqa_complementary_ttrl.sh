#!/usr/bin/env bash
# TTRL-style training on the MedQA complementary-label train split.
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen2_5_3b_cl_ttrl}
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${HOME}/checkpoints/complementary_labels_cl_ttrl"}
...
REWARD=(
    ...
    reward.reward_manager.name=MedQAComplementaryTTRLRewardManager
    reward.reward_manager.module.path="${PROJECT_DIR}/rewards/medqa_complementary_ttrl_reward.py"
    reward.custom_reward_function.path="${PROJECT_DIR}/rewards/medqa_complementary_ttrl_reward.py"
