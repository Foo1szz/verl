#!/usr/bin/env bash
# Entropy-weighted TTRL-style GRPO training for Qwen2.5-3B on full MedQA.
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen2_5_3b_entropy_ttrl_full}
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${HOME}/checkpoints/complementary_labels_entropy_ttrl_full"}
...
REWARD=(
    ...
    reward.reward_manager.name=MedQAEntropyWeightedTTRLRewardManager
    reward.reward_manager.module.path="${PROJECT_DIR}/rewards/medqa_entropy_weighted_ttrl_reward.py"
    reward.custom_reward_function.path="${PROJECT_DIR}/rewards/medqa_entropy_weighted_ttrl_reward.py"
